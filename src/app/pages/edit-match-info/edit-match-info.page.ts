...
@Component({
  selector: 'app-edit-match-info',
  templateUrl: './edit-match-info.page.html',
  styleUrls: ['./edit-match-info.page.scss'],
})

export class EditMatchInfoPage implements OnInit {
  ...
  ngOnInit() {
   ...
   private async returnMatchDetails(matchId: string){     
    ...
    //if (this.homeScore != null)
      //  {
    console.log("this.homeScore = " + this.homeScore + "    this.homeScore.toString= " + this.homeScore.toString)
