...
@Component({
  selector: 'app-edit-match-scorers',
  templateUrl: './edit-match-scorers.page.html',
  styleUrls: ['./edit-match-scorers.page.scss'],
})
export class EditMatchScorersPage implements OnInit {
